...
p=$( name=$(echo exit | telnet 10.50.12.165 80 2>/dev/null | grep "Connected") ; if [ "$name" == "" ] ; then  echo "80 is Down" ; else echo "80 is Up" ; fi; name=$(echo exit | telnet 10.50.12.165 3306 2>/dev/null | grep "Connected") ; if [ "$name" == "" ] ; then  echo "3306 is Down" ; else echo "3306 is Up" ; fi)
